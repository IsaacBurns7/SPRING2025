...
def run_camera():
    ...
    # Set Basic TrackingCamera arguments.
    camera_kwargs = {
        ...
        'mode' : 'tracking',                  # recording, tracking, motion, calibration
        ...
        'camera_distance': 1.0                # camera distance (in METERS) to stickers, required for tracking and motion modes
    }
