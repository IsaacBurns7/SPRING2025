...
def find_momentum_of_system(csv_file, output_file,
                            ...
                            moi_mass = 9.7e-4, moi_object = 1.32e-6, mass = 0.020): #units in kg m^2
    ...
    max_angular_momentum = df['angular_momentum_mass'].max() + df['angular_momentum_object'].max()
    ...
    plt.subplot(2, 1, 1)
    plt.scatter(df['frame_no'], df['angular_momentum_object'], color = "blue", alpha = 0.7, s = 20, label = 'L-Shape')
    plt.scatter(df['frame_no'], df['angular_momentum_mass'], color = "red", alpha = 0.7, s = 20, label = 'Mass')
    plt.scatter(df['frame_no'], df['angular_momentum_mass'] + df['angular_momentum_object'], color = "green", alpha = 0.7, s = 20, label = 'Composite')
